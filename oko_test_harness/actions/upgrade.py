...
class UpgradeOperatorAction(BaseAction):
    ...
    params = {"version", "values", "values_file", "expect_restart", "legacy_api"}
    ...
    def execute(self, params):
        ...
        result = install.run({k: v for k, v in params.items() if k in ("version", "values", "values_file", "legacy_api")})
